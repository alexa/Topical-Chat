...
build.py will read each file in /topical_chat/reading_sets/pre-built folder, create a replica JSON with the exact same name with the actual reading sets included in /topical_chat/reading_sets/post-built folder.
...
**Each .json file in topical_chat/conversations/ directory has the specified format:**
```
{
<conversation_id>: {
...
**Each .json file in topical_chat/reading_sets/ directory:**
```
{
<conversation_id> : {
	“config” : <config>,
